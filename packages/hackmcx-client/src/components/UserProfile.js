						...
						<div className={useStyles.root}>
							...
							<label htmlFor='icon-button-file'>
								<IconButton
									...
									style={{
										'border-radius': '20px',
										background: 'rgb(160 3 24)',
									}}
									// style={{background:"#a00318ad"}}
								>
									<Avatar
										//Below works with Jpg only
										// src={'data:image/png;base64,' + user.imageData}
										//Works with png only\
										{...this.conditionCheck(user)}
										src={
											'data:image/png;base64, ' +
											extraCharacter +
											user.imageData
										}
										{...console.log('data:image/png;base64, ' + user.imageData)}
										className={useStyles.large}
										style={{
											margin: '10px',
											width: '150px',
